Meteor.methods({
  ...
  userConfirmAcceptance: (acceptTravel, explaination) => {
  ...
  userRejectAcceptance: () => {
    ...
    throw new Meteor.Error('Not Accepted', 'User has not been accepted.');
  },
